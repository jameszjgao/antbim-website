    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-slate-50 dark:bg-transparent">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(245,138,7,0.22),transparent)] dark:bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(245,138,7,0.35),transparent)]" />
          <div className="pointer-events-none absolute inset-0 bg-grid-fade-light bg-[length:24px_24px] opacity-50 dark:bg-grid-fade dark:opacity-40" />
          <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-10 sm:px-6 sm:pt-14 lg:pb-28 lg:pt-20">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="#product"
                className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-5 py-2.5 text-sm font-medium text-slate-800 shadow-sm transition hover:bg-slate-50 dark:border-white/15 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
              >
                了解产品能力
              </a>
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-2">
              {heroHighlights.map((t) => (
                <span
                  key={t}
                  className="rounded-full border border-slate-200 bg-white px-3 py-1 text-xs text-slate-700 shadow-sm dark:border-white/10 dark:bg-ink-900/60 dark:text-slate-200"
                >
                  {t}
                </span>
              ))}
            ...
            <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((s) => (
                <div
                  key={s.label}
                  className="rounded-2xl border border-slate-200/80 bg-gradient-to-b from-white to-slate-50/80 p-5 shadow-sm dark:border-white/10 dark:from-white/[0.07] dark:to-transparent dark:shadow-soft"
                >
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="mt-12 space-y-14">
              {featureBlocks.map((block, idx) => (
                <div
                  key={block.id}
                  className="grid gap-8 rounded-3xl border border-slate-200/80 bg-gradient-to-br from-white to-slate-50/50 p-6 shadow-sm sm:p-10 dark:border-white/10 dark:from-white/[0.04] dark:to-transparent dark:shadow-none lg:grid-cols-12 lg:gap-10"
                >
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="mt-10 grid gap-4 lg:grid-cols-3">
              {cases.map((c) => (
                <article
                  key={c.title}
                  className="flex flex-col rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-ink-950/50"
                >
